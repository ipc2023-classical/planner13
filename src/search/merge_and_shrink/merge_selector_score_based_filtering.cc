...
void MergeSelectorScoreBasedFiltering::initialize(const task_representation::FTSTask &fts_task) {
...
static options::PluginShared<MergeSelector> _plugin("mas_score_based_filtering", _parse);
}
