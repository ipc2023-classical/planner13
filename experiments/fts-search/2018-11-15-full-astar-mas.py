...
def main(revisions=None):
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-masdfpbisim50k'.format(BASELINE_REV), '{}-astar-masdfpbisim50k-transform-full-bisim-labelreduction-dfp1k-t900'.format(REVISION)),
                ('{}-astar-masdfpbisim50k'.format(BASELINE_REV), '{}-astar-masdfpbisim50k-transform-full-bisim-labelreduction-miasm1k-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp1k-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm1k-t900'.format(REVISION)),
            ],
            format='html',
