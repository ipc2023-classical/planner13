...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('astar-blindunit-atomic', ["--transform", "cost(cost_type=one)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blindunit-transform-atomic-labelreduction', ["--transform", "transform_merge_and_shrink(label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=false,run_main_loop=false,cost_type=one)", "--search", "astar(blind, cost_type=one)"]),

        IssueConfig('astar-blind-transform-atomic-weakbisim-labelreduction', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=false,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blind-transform-full-weakbisim-labelreduction-dfp100-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(100),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blind-transform-full-weakbisim-labelreduction-dfp1000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(1000),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blind-transform-full-weakbisim-labelreduction-dfp10000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(10000),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blind-transform-full-weakbisim-labelreduction-miasm100-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(100),sf_miasm(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),max_states=100,threshold_before_merge=1),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blind-transform-full-weakbisim-labelreduction-miasm1000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(1000),sf_miasm(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),max_states=1000,threshold_before_merge=1),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
        IssueConfig('astar-blind-transform-full-weakbisim-labelreduction-miasm10000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(10000),sf_miasm(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true),max_states=10000,threshold_before_merge=1),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)", "--search", "astar(blind, cost_type=one)"]),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-astar-blindunit-atomic'.format(REVISION),
        '{}-astar-blindunit-transform-atomic-labelreduction'.format(REVISION),
        '{}-astar-blind-transform-atomic-weakbisim-labelreduction'.format(REVISION),
        '{}-astar-blind-transform-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION),
        '{}-astar-blind-transform-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION),
        '{}-astar-blind-transform-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION),
        '{}-astar-blind-transform-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION),
        '{}-astar-blind-transform-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION),
        '{}-astar-blind-transform-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION),
    ])

    BASELINE_REV = 'fts-search-base-v2'
    exp.add_fetcher('data/2019-02-23-astarunit-baseline-eval',merge=True)

    outfile = os.path.join(exp.eval_dir, get_experiment_name() + '-regular-vs-fts.html')
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blindunit-atomic'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blindunit-transform-atomic-labelreduction'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-atomic-weakbisim-labelreduction'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transform-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
