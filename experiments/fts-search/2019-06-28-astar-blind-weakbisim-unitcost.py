...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('astar-blind-transformunitcost-atomic-weakbisim-coarsest-labelreduction', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=false,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp100-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(100),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp1000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(1000),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp10000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(10000),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm100-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(100),sf_miasm(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),max_states=100,threshold_before_merge=1),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm1000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(1000),sf_miasm(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),max_states=1000,threshold_before_merge=1),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm10000-t900', ["--transform", "transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(10000),sf_miasm(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true,coarsest=true),max_states=10000,threshold_before_merge=1),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true)", "--search", "astar(blind,cost_type=one)"]),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-astar-blind-transformunitcost-atomic-weakbisim-coarsest-labelreduction'.format(REVISION),
        '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp100-t900'.format(REVISION),
        '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp1000-t900'.format(REVISION),
        '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp10000-t900'.format(REVISION),
        '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm100-t900'.format(REVISION),
        '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm1000-t900'.format(REVISION),
        '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm10000-t900'.format(REVISION),
    ])

    OLD_REV = 'b55624a83c62'
    exp.add_fetcher('data/2019-05-29-astar-blind-weakbisim-unitcost-eval', filter_algorithm=[
    ...
    outfile = os.path.join(exp.eval_dir, get_experiment_name() + '-compare.html')
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-blind-transformunitcost-atomic-weakbisim-labelreduction'.format(OLD_REV), '{}-astar-blind-transformunitcost-atomic-weakbisim-coarsest-labelreduction'.format(REVISION)),
                ('{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(OLD_REV), '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(OLD_REV), '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(OLD_REV), '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(OLD_REV), '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(OLD_REV), '{}-astar-blind-transformunitcost-full-weakbisim-coarsest-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
