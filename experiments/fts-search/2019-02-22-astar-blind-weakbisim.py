...
def main(revisions=None):
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-blind-transform-atomic-weakbisim-labelreduction'.format(REVISION), '{}-astar-blind-transform-atomic-weakbisim-iggirr-labelreduction'.format(REVISION)),
                ('{}-astar-blind-transform-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION), '{}-astar-blind-transform-full-weakbisim-iggirr-labelreduction-dfp1000-t900'.format(REVISION)),
            ],
            format='html',
            attributes=attributes,
        ),
