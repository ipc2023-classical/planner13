...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp100-t900-finallrshrink', ["--transform", 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(100),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true,run_final_lr_shrink=true)', '--search',  'lazy_greedy([ff(cost_type=one)], cost_type=one)']),
        IssueConfig('lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900-finallrshrink', ["--transform", 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(1000),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true,run_final_lr_shrink=true)', '--search',  'lazy_greedy([ff(cost_type=one)], cost_type=one)']),
        IssueConfig('lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900-finallrshrink', ["--transform", 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(10000),goal_relevance,dfp,total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true,run_final_lr_shrink=true)', '--search',  'lazy_greedy([ff(cost_type=one)], cost_type=one)']),
        IssueConfig('lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900-finallrshrink', ["--transform", 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(000),sf_miasm(shrink_strategy=shrink_own_bisimulation,threshold_before_merge=1,max_states=100),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true,run_final_lr_shrink=true)', '--search',  'lazy_greedy([ff(cost_type=one)], cost_type=one)']),
        IssueConfig('lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900-finallrshrink', ["--transform", 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(1000),sf_miasm(shrink_strategy=shrink_own_bisimulation,threshold_before_merge=1,max_states=1000),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true,run_final_lr_shrink=true)', '--search',  'lazy_greedy([ff(cost_type=one)], cost_type=one)']),
        IssueConfig('lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900-finallrshrink', ["--transform", 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=false),merge_strategy=merge_stateless(merge_selector=score_based_filtering(scoring_functions=[product_size(10000),sf_miasm(shrink_strategy=shrink_own_bisimulation,threshold_before_merge=1,max_states=10000),total_order(atomic_ts_order=reverse_level,product_ts_order=new_to_old,atomic_before_product=false)])),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=true,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true,run_final_lr_shrink=true)', '--search',  'lazy_greedy([ff(cost_type=one)], cost_type=one)']),
    }
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp100-t900-finallrshrink'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900-finallrshrink'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900-finallrshrink'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900-finallrshrink'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900-finallrshrink'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900-finallrshrink'.format(REVISION),
    ],filter=[quality_filters.store_costs, quality_filters.add_quality])

    exp.add_fetcher('data/2019-05-22-lazygreedy-ff-unitcost-eval', filter_algorithm=[
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION),
    ],merge=True)

    outfile = os.path.join(exp.eval_dir, get_experiment_name() + '-compare-finallrshrink.html')
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp100-t900-finallrshrink'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900-finallrshrink'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900-finallrshrink'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900-finallrshrink'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900-finallrshrink'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900-finallrshrink'.format(REVISION)),
            ],
            format='html',
