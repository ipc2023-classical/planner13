...
def main(revisions=None):
    ...
    BASELINE_REV = 'fts-search-base-mas'
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-atomic'.format(REVISION)),
