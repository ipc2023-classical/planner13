...
def main(revisions=None):
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-lazy-ff-transformunitcost-atomic'.format(REVISION),
        '{}-lazy-ff-transformunitcost-atomic-labelreduction'.format(REVISION),
        '{}-lazy-ff-transformunitcost-atomic-weakbisim-labelreduction'.format(REVISION),
    ...
    exp.add_fetcher('data/2019-05-22-lazygreedy-ff-unitcost-eval', filter_algorithm=[
        '{}-lazy-ff-transformunitcost-atomic-weakbisim-labelreduction'.format(OLD_REV),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp100-t900'.format(OLD_REV),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(OLD_REV),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(OLD_REV),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(OLD_REV),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(OLD_REV),
        '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(OLD_REV),
    ],merge=True)
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ff-transformunitcost-atomic-weakbisim-labelreduction'.format(OLD_REV), '{}-lazy-ff-transformunitcost-atomic-weakbisim-labelreduction'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(OLD_REV), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(OLD_REV), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(OLD_REV), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(OLD_REV), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(OLD_REV), '{}-lazy-ff-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
