...
def main(revisions=None):
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-lazy-ff-transformunit-atomic'.format(REVISION),
        '{}-lazy-ff-transformunit-atomic-labelreduction'.format(REVISION),
        '{}-lazy-ff-transformunit-atomic-weakbisim-labelreduction'.format(REVISION),
        '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION),
        '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION),
        '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION),
        '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION),
        '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION),
        '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION),
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-atomic'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-atomic-labelreduction'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-atomic-weakbisim-labelreduction'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
    ...
    exp.add_fetcher('data/2019-02-26-lazygreedy-ff-eval',merge=True)
    outfile = os.path.join(exp.eval_dir, get_experiment_name() + '-non-unitcost-vs-unitcost.html')
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ff-transform-atomic'.format(REVISION), '{}-lazy-ff-transformunit-atomic'.format(REVISION)),
                # ('{}-lazy-ff-transform-atomic-labelreduction'.format(REVISION), '{}-lazy-ff-transformunit-atomic-labelreduction'.format(REVISION)),
                ('{}-lazy-ff-transform-atomic-weakbisim-labelreduction'.format(REVISION), '{}-lazy-ff-transformunit-atomic-weakbisim-labelreduction'.format(REVISION)),
                # ('{}-lazy-ff-transform-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-lazy-ff-transform-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION)),
                # ('{}-lazy-ff-transform-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION)),
                # ('{}-lazy-ff-transform-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-lazy-ff-transform-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                # ('{}-lazy-ff-transform-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION), '{}-lazy-ff-transformunit-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
            ],
            format='html',
            attributes=attributes,
        ),
