...
def main(revisions=None):
    ...
    exp.add_fetcher('data/2018-11-19-baseline-lazygreedy-ff-eval', filter_algorithm=[
        '{}-lazy-ff-pref'.format(BASELINE_REV),
    ],merge=True)
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-atomic'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-atomic-labelreduction'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-atomic-bisimown-labelreduction'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-full-bisimown-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-full-bisimown-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-full-bisimown-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-full-bisimown-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-full-bisimown-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-lazy-ff-pref'.format(BASELINE_REV), '{}-lazy-ffpref-transform-full-bisimown-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
