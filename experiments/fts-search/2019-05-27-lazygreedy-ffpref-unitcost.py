...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('lazy-ffpref-transformunitcost-atomic-weakbisim-labelreduction', ['--transform', 'transform_merge_and_shrink(shrink_strategy=shrink_weak_bisimulation(ignore_irrelevant_tau_groups=true, apply_haslum_rule=true),label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=true,run_main_loop=false,max_time=900,cost_type=one,prune_transitions_from_goal=true,prune_transitions_from_goal=true)', "--heuristic", "hff=ff(cost_type=one)", "--search", "lazy_greedy([hff], preferred=[hff],cost_type=one)"]),
    ...
    exp.add_fetcher('data/2019-05-22-lazygreedy-ffpref-unitcost-eval', filter_algorithm=[
        '{}-lazy-ffpref-transformunitcost-atomic-weakbisim-labelreduction'.format(OLD_REV),
        '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp100-t900'.format(OLD_REV),
        '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(OLD_REV),
        '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(OLD_REV),
        '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(OLD_REV),
        '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(OLD_REV),
        '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(OLD_REV),
    ],merge=True)
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ffpref-transformunitcost-atomic-weakbisim-labelreduction'.format(OLD_REV), '{}-lazy-ffpref-transformunitcost-atomic-weakbisim-labelreduction'.format(REVISION)),
                ('{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(OLD_REV), '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(OLD_REV), '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(OLD_REV), '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(OLD_REV), '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(OLD_REV), '{}-lazy-ffpref-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
