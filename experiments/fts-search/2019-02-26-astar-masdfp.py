...
def main(revisions=None):
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-astar-masdfpbisim50k-transform-atomic'.format(REVISION),
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-masdfpbisim50k'.format(BASELINE_REV), '{}-astar-masdfpbisim50k-transform-atomic'.format(REVISION)),
