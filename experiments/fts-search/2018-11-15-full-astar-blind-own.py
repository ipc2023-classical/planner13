...
def main(revisions=None):
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-astar-blind-full-transform-own-labelreduction-dfp1k-t900'.format(REVISION),
        '{}-astar-blind-full-transform-own-labelreduction-miasm1k-t900'.format(REVISION),
    ])
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-blind'.format(BASELINE_REV), '{}-astar-blind-full-transform-own-labelreduction-dfp1k-t900'.format(REVISION)),
                ('{}-astar-blind'.format(BASELINE_REV), '{}-astar-blind-full-transform-own-labelreduction-miasm1k-t900'.format(REVISION)),
            ],
            format='html',
