...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('astar-blind-transformunitcost-atomic', ["--transform", "cost(cost_type=one)", "--search", "astar(blind,cost_type=one)"]),
        IssueConfig('astar-blind-transformunitcost-atomic-labelreduction', ["--transform", "transform_merge_and_shrink(label_reduction=exact(max_time=300,atomic_fts=true,before_shrinking=true,before_merging=false),shrink_atomic_fts=false,run_main_loop=false,cost_type=one)", "--search", "astar(blind,cost_type=one)"]),
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        ...
        '{}-astar-blind-transformunitcost-atomic-labelreduction'.format(REVISION),
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-atomic'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-atomic-labelreduction'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-atomic-weakbisim-labelreduction'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-astarunit-blind'.format(BASELINE_REV), '{}-astar-blind-transformunitcost-full-weakbisim-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
