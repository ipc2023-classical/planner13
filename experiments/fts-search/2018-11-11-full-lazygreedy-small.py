...
def main(revisions=None):
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-lazy-ff-transform-full-bisim-labelreduction-dfp100-t900'.format(REVISION),
        '{}-lazy-ff-transform-full-bisim-labelreduction-dfp1k-t900'.format(REVISION),
        '{}-lazy-ff-transform-full-bisim-labelreduction-dfp10k-t900'.format(REVISION),
        '{}-lazy-ff-transform-full-bisim-labelreduction-miasm100-t900'.format(REVISION),
        '{}-lazy-ff-transform-full-bisim-labelreduction-miasm1k-t900'.format(REVISION),
        '{}-lazy-ff-transform-full-bisim-labelreduction-miasm10k-t900'.format(REVISION),
    ])
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transform-full-bisim-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transform-full-bisim-labelreduction-dfp1k-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transform-full-bisim-labelreduction-dfp10k-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transform-full-bisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transform-full-bisim-labelreduction-miasm1k-t900'.format(REVISION)),
                ('{}-lazy-ff'.format(BASELINE_REV), '{}-lazy-ff-transform-full-bisim-labelreduction-miasm10k-t900'.format(REVISION)),
            ],
            format='html',
