...
def main(revisions=None):
    ...
    exp.add_absolute_report_step(attributes=attributes, filter_algorithm=[
        '{}-astar-masmiasmbisim50k-transform-atomic'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-atomic-labelreduction'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-atomic-bisim-labelreduction'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp100-t900'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp1000-t900'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp10000-t900'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm100-t900'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm1000-t900'.format(REVISION),
        '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm10000-t900'.format(REVISION),
    ])

    BASELINE_REV = 'fts-search-base-v2'
    exp.add_fetcher('data/2019-02-18-astar-baseline-eval', filter_algorithm=[
        '{}-astar-masmiasmbisim50k'.format(BASELINE_REV),
    ],merge=True)
    ...
    exp.add_report(
        ComparativeReport(
            algorithm_pairs=[
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-atomic'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-atomic-labelreduction'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-atomic-bisim-labelreduction'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp100-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp1000-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-dfp10000-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm100-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm1000-t900'.format(REVISION)),
                ('{}-astar-masmiasmbisim50k'.format(BASELINE_REV), '{}-astar-masmiasmbisim50k-transform-full-bisim-labelreduction-miasm10000-t900'.format(REVISION)),
            ],
            format='html',
